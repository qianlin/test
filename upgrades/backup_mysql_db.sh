...
DB_Password=openstack ## the password for the admin user
DB_Host=10.1.0.203
...
skipTokenDataInKeystone=1
NameofKeystoneDB="keystone"
DB_BackupSchemas="ceilometer cinder glance horizon keystone nova quantum"
...
DB_RemainBackCnt=5 ## the count of the reserved back files
...
backFileName="openStackDatabase_${cur_Time}"
# echo $backFileName
